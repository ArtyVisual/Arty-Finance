                    ...
                    <table className="table-auto mx-auto md:w-3/4 overflow-hidden rounded-md pt-24 mb-16 ">
                        ...
                        <tbody className=''>
                            {combinedArray.map((item, index) => (
                                <tr className={`border-2 rounded-md  font-semibold md:text-lg ${item.status == "Dr" ? 'text-red-300' : 'text-green-300'} text-xs border-t-2 py-52 border-white my-3`} key={index}>
